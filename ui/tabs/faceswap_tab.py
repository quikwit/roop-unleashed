    ...
    with gr.Tab("🎭 Face Swap"):
        with gr.Row(variant='panel'):
            with gr.Column(scale=2):
                ...
                with gr.Row(variant='panel'):
                    ...
                    bt_destfiles = gr.FileExplorer(label='Target File(s)', file_count="multiple", root="/content/drive/MyDrive/targets/main")
                with gr.Row(variant='panel'):
                    gr.Markdown('')
        ...
        with gr.Row(variant='panel'):
            with gr.Column(scale=1):
                selected_face_detection = gr.Dropdown(["First found", "All faces", "Selected face", "All female", "All male"], value="All faces", label="Select face selection for swapping")
                max_face_distance = gr.Slider(0.01, 1.0, value=0.50, label="Max Face Similarity Threshold")
